...
import vectorWhite from "../../../public/assets/images/Vector 9.png";
  ...
  return (
    <S.Header>
      <S.ContentContainer>
        ...
        <S.NavBar>
          <Link href="#contact">{t('header.contactButton')}</Link>
          <Link href="#trails">{t('header.trailsButton')}</Link>
          <Link href="#login">
                    ...
                    <S.UserUl>
                      ...
                      <S.Dropdown isOpen={isDropdownOpen}>
                        <S.Logout onClick={() => handleLogout()}>
                          ...
                          <S.Span2>{t('login.logout')}</S.Span2>
                        </S.Logout>
                      </S.Dropdown>
                    </S.UserUl>
                  }
      ...
      <S.NavMobile className={isMenuOpen ? "is-open" : ""}>
        {!token ?
          <>
            <Link href="/loginRegister" onClick={() => setIsMenuOpen(false)} style={{ "--i": "1" } as React.CSSProperties}>
              Login
            </Link>
